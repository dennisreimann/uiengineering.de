...
gulp.task('mixins', cb =>
  gulp.src(paths.mixins)
    .pipe(p.concat('mixins.pug'))
    .pipe(p.banner('//- This file gets generated by the `gulp mixins` task.\n//- Do not edit it manually!\n\n'))
...
gulp.task('watch', () => {
  ...
  gulp.watch(paths.mixins, ['mixins'])
...
gulp.task('pug', cb => runSequence('mixins', ['pages', 'episodes', 'feed'], cb))
gulp.task('images', cb => runSequence('images:resize', 'images:optimize', cb))
gulp.task('build', cb => runSequence(['styles', 'copy', 'pug'], cb))
gulp.task('develop', cb => runSequence('mixins', ['build', 'patterns'], ['watch', 'browserSync'], cb))
